...
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-upload" aria-hidden="true"></i>
  Posts<span class="caret"></span></a>
                        ...
                        <ul class="dropdown-menu">
                           <?php
                            ...
                            if(mysqli_num_rows ($run)>0)
                            {
                             ...
                             {
                                 $category = ucfirst($row['title']);
                                 $id =$row['id'];
                                 
                               echo "<li><a href='post.php'>$category</a></li>";
                    ...
                    <li><a href="post.php"><i class="fa fa-upload" aria-hidden="true"></i>
Create  Post</a></li>
                                
                                                        
                    <li><a href="../../../project/admin/index.php"><i class="fa fa-lock" aria-hidden="true"></i>
 Admin-Panel</a></li>
